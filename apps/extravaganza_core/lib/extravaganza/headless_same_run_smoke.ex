defmodule Extravaganza.HeadlessSameRunSmoke do
  ...
  defp route_coverage do
    routes = [
      ...
      route("POST", "/api/v1/live/linear-source", :live_linear_source),
      route("POST", "/api/v1/live/linear-current-states", :live_linear_current_states),
      route("POST", "/api/v1/live/codex-turn", :live_codex_turn),
      route("POST", "/api/v1/live/linear-publication", :live_linear_publication),
      route("POST", "/api/v1/live/linear-graphql-tool", :live_linear_graphql_tool),
      route("POST", "/api/v1/live/github-evidence", :live_github_evidence),
      route("POST", "/api/v1/live/github-pr-cleanup", :live_github_pr_cleanup),
      route("POST", "/api/v1/live/smoke", :live_smoke),
