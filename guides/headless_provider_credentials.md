...
|---|---|---|---|
| linear source intake | `mix extravaganza.headless.live.linear_source --live-product-path --ack-headless-guardrails --json` | Linear | `LINEAR_API_KEY` |
| linear current states | `mix extravaganza.headless.live.linear_current_states --live-product-path --ack-headless-guardrails --json` | Linear | `LINEAR_API_KEY` |
...
| linear publication | `mix extravaganza.headless.live.linear_publication --live-product-path --ack-headless-guardrails --json` | Linear | `LINEAR_API_KEY` |
| linear GraphQL dynamic tool | `mix extravaganza.headless.live.linear_graphql_tool --live-product-path --ack-headless-guardrails --json` | Linear | `LINEAR_API_KEY` |
...
~/scripts/with_bash_secrets mix extravaganza.headless.live.linear_current_states --live-product-path --ack-headless-guardrails --json
~/scripts/with_bash_secrets mix extravaganza.headless.live.codex_turn --live-product-path --ack-headless-guardrails --json
~/scripts/with_bash_secrets mix extravaganza.headless.live.linear_publication --live-product-path --ack-headless-guardrails --json
