...
| Source publication preview | `mix extravaganza.headless.source_preview --json` | `GET /api/v1/subjects/:subject_id/source-publication` | no script exists today | Partial |
